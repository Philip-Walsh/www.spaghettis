    ...
    try {
        ...
        return (
            <Card className="max-w-2xl">
                ...
                <div className="text-lg font-bold">Content temporarily unavailable</div>
                <p className="italic">Failed to load random Wikipedia article. This might be due to network issues during build time.</p>
            </Card>
        );
    }
}
