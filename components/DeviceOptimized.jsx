...
/**
 * Component that adapts content based on device type detected by edge function
 * Also fetches device-specific data from API
 */
export default function DeviceOptimized({ 
  children,
  mobileContent,
  desktopContent,
