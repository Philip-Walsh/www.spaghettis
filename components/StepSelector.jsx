    ...
    return (
        <fieldset className={styles.fieldset} aria-labelledby={`legend-${step.key}`}>
            <legend id={`legend-${step.key}`} className={styles.legend} tabIndex={-1}>
                {step.icon && <span style={{ marginRight: 8, verticalAlign: 'middle' }}>{step.icon}</span>}
                {step.label}
            </legend>
                        ...
                        >
                            ...
                            >
                                <div className={styles.iconWrap} style={{ fontSize: 32, marginRight: 16 }}>
                                    <span
                                        className={styles.icon + ' noto-emoji'}
                                        style={{
                                            fontFamily:
                                ...
                                <div className={styles.optionTextWrap} style={{ flex: 1, minWidth: 0 }}>
                                    <h3 className={styles.optionTitle} style={{ fontWeight: 700, fontSize: '1.15rem' }}>
                                        {item.name}
                                    </h3>
                                    <div
                                    ...
                                    {item.description && (
                                        <div style={{ fontSize: '0.95rem', color: '#444', marginTop: 4 }}>
                                            {item.description}
                                        </div>
                                    )}
                                </div>
