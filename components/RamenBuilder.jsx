...
export default function RamenBuilder() {
    ...
    // Don't render if menuOptions is not available
    if (!menuOptions) {
        return null;
    }
    ...
    const calculateOrderPrice = (options) => {
        let total = 2.5; // Base price for noodles
    ...
    return (
        <main className={styles.builderContainer}>
            ...
            <header className={styles.title}>
                <h1>{isSummaryStep ? 'Selection Complete!' : 'Build Your Perfect Ramen'}</h1>
            </header>
            ...
            <section className={styles.contentContainer}>
                <article className={styles.builderContent}>
                    ...
                    <section className={styles.stepContent}>
                        ...
                        <section className={styles.actions}>
                            {isLastStep ? (
                                <button className={styles.actionButton} onClick={addToCart} disabled={!canAddToCart()}>
                                    Finish & Add to Cart
                                </button>
                            ) : (
                                <button className={styles.actionButton} onClick={addToCart} disabled={!canAddToCart()}>
                ...
                <aside className={styles.cartContainer}>
                    <Cart items={cartItems} onAddItem={addToCart} onRemoveItem={removeFromCart} />
                </aside>
            </section>
        </main>
    );
